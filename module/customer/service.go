...
type Service interface {
	...
	ListCustomersByCitizenship(in string) ([]model.Customer, error) // Get all Customers by citizenship
	...
	GetCustomerByCustomerPhone(in string) ([]model.Customer, error) // Get Customer by customer_phone
}
